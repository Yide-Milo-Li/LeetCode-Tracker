...
[Release 1.1.2 notes](releases/1.1.2.md) · [Windows installation and native runtime](desktop.md) · [Current verification and limitations](status.md)
...
All maintained documentation is English. The implemented desktop interface supports Chinese and English, with four main destinations: Today, Problems, Progress and Notes, plus Settings. Release 1.1.2 includes a Windows x64 Tauri installer while retaining browser source mode.
...
- [Topic practice insights](topic-practice-insights.md): Spaced repetition policies, evidence-based topic knowledge profiles, and adaptive review rules.
