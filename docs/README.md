...
[Release 1.2.0 notes](releases/1.2.0.md) · [Windows installation and native runtime](desktop.md) · [Current verification and limitations](status.md)
...
All maintained documentation is English. The implemented desktop interface supports Chinese and English, with four main destinations: Today, Problems, Progress and Notes, plus Settings. Release 1.2.0 includes a Windows x64 Tauri installer while retaining browser source mode.
