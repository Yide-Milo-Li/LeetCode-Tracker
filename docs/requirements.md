...
Release 1.0.0 shares these desktop UI requirements between source browsers and the Windows Tauri shell. Native packaging does not expand mobile support or imply completion of the outstanding [desktop acceptance work](status.md).
